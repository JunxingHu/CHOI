...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default='experiments/ho3d.yaml', metavar="FILE", help="path to config file")
    parser.add_argument("--resume", default=False, help="whether to attempt to resume from the checkpoint directory",)
    parser.add_argument("--ckpt", default='weights/ho3d/checkpoints/ho3d_weight.ckpt', metavar="FILE", help="path to config file")
