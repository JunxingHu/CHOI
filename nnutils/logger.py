"""
This script is borrowed from https://github.com/JudyYe/ihoi
"""
...
class MyLogger(TensorBoardLogger):
    ...
    def __init__(self, resume=True, subfolder='', **kwargs):
        self.subfolder = subfolder if subfolder is not None and len(subfolder) > 0 else 'train' #train
        ...
        if not resume:
            ...
            os.system(cmd)        
        log_file = "{0}/{1}.log".format(self.log_dir, self.subfolder) # xxx/train.log
