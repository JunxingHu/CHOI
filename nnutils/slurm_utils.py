...
def add_slurm_args(arg_parser):
    ...
    arg_parser.add_argument("--sl_time",default=1080, type=int)
    arg_parser.add_argument("--sl_dir", default='./', type=str)
    arg_parser.add_argument("--sl_work",default=10, type=int)
    arg_parser.add_argument("--sl_node",default=1, type=int)
